...
LINHA_EVOLUCAO_PATRIMONIAL = 'rgba(178, 45, 178, 0.7)'
LISTA_DE_CORES_LINHAS = ['rgba(244, 243, 242, 0.9)', 'rgba(178, 45, 178, 0.7)', 'rgba(76,0,176,0.7)', 'rgba(138,0,179,0.7)', 'rgba(103,0,103,0.7)', 'rgba(87,53,106,0.4)', 'rgba(177,0,205,0.4)', 'rgba(190,46,214,0.4)', 'white']
HOVER_LINE_GRAPH = {
